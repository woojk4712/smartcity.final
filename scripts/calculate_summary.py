...
def main() -> None:
    ...
    for key, cfg in AREAS.items():
        ...
        row_data = {
                ...
                "station_intersection_area_500m_m2": spatial.get(key, {}).get("station_intersection_area_500m_m2"),
                "station_intersection_area_1km_m2": spatial.get(key, {}).get("station_intersection_area_1km_m2"),
                "station_count_500m": spatial.get(key, {}).get("station_count_500m"),
                "station_count_1km": spatial.get(key, {}).get("station_count_1km"),
                "station_used_list_500m": spatial.get(key, {}).get("station_used_list_500m"),
                "station_used_list_1km": spatial.get(key, {}).get("station_used_list_1km"),
                "station_nearest_list": spatial.get(key, {}).get("station_nearest_list"),
                "station_zero_result_validation": spatial.get(key, {}).get("station_zero_result_validation"),
                "allocation_meta": {
                    "population": pop_meta,
