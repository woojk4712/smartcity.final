...
AREAS = {
    ...
    "cheongna": {
        ...
        "sgis_code": "23080",
        "source": "인천경제자유구역청 청라국제도시 지구단위계획 결정고시 및 토지이용계획 용도지역",
        "definition": "청라국제업무지구는 실제 입주·건축 여부와 무관하게 IFEZ 지구단위계획 결정고시 및 토지이용계획에서 업무·상업 기능을 위해 지정된 중심상업지역·일반상업지역 계획용지로 정의한다.",
        "boundary_basis": "IFEZ 지구단위계획 결정고시의 업무·상업 계획용지 기준",
        "boundary_note": "사후적으로 활성화된 필지만 고르지 않고, 중심상업지역·일반상업지역으로 지정된 계획용지 전체를 사용한다. 공원·녹지·학교 지목 필지는 제외하며 건축물 입지 여부는 경계 선정에 사용하지 않는다.",
    },
}
