...
AREAS = {
    ...
    "cheongna": {
        ...
        "sgis_code": "23080",
        "source": "인천경제자유구역청 청라국제도시 개발계획 또는 지구단위계획 자료",
        "definition": "청라국제도시 내 국제업무용지 또는 국제업무단지로 계획된 구역을 비교 대상 업무지구로 정의한다.",
        "boundary_basis": "청라국제업무용지/국제업무단지 대응 필지 기준",
        "boundary_note": "청라동 93~107 지번대와 토지이용계획 상업/준주거 필터는 공식 국제업무용지 경계에 대응되는 필지 범위를 추출하기 위한 보조 조건이다.",
    },
}
