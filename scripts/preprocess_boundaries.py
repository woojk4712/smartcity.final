...
def _cheongna_functional_filter(parcels: gpd.GeoDataFrame) -> tuple[gpd.GeoDataFrame, dict]:
    ...
    for _, row in parcels.iterrows():
        ...
        public_exclusion = _contains_any(zone_text, PUBLIC_EXCLUDE_KEYWORDS) and score < 4.0
        selected_flag = score >= FUNCTIONAL_SCORE_THRESHOLD and not pure_exclusion and not public_exclusion
